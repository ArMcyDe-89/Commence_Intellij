public class LinkingTheLists {
    ...
    public static void main(String[] args) {
        ...
        LinkedList.printLL(EvenPartsReversed(LinkedList.createList(new Object[] { 3, 5, 7, 9, 12, 6})));
    ...
    public static Node EvenPartsReversed(Node head){
        ...
        while(N.next!=null){Node save = N;
            if(((int)N.elem)%2 ==0){ 
                ...
                }save.next = evens; Node s = evens; LinkedList.printLL(save); LinkedList.printLL(trav);

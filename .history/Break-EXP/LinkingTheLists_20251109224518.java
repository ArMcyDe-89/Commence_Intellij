public class LinkingTheLists {
    ...
    public static void main(String[] args) {
        ...
        LinkedList.printLL(EvenPartsReversed(LinkedList.createList(new Object[] {24,18,2, 3, 5,4,6,8,24,62,66,98,30,45,32,24,54,68,78,90,94,14, 7, 9, 12, 6})));
        ...
        while(N.next != null){
            ...
            if(((int)N.next.elem)%2 == 0 && N.next!=null){
                ...
                while (((int) trav.elem)%2 == 0 && trav != null) {
                 ...
                 while (s.next.elem != null ) {
                     s=s.next;
                 }s.next = trav; if(trav != null){N = trav;} send = save;
            }N = N.next;
        }

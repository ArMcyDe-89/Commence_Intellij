...
public static void NeededPlatformsCheck (String [] A, String [] D){
    ...
    for(int i = 0; i<arr.length;i++){
        occupied = new Boolean[platform]; int occ = 0; for(int k = 0;k<platform;k++){occupied[k]}
        for(int j = 0; j<i;j++){
    ...
    System.out.println("Minimum "+platform+" platforms are required to safely arrive and depart all trains.");
}

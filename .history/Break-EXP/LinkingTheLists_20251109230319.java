public class LinkingTheLists {
    ...
    public static void main(String[] args) {
        ...
        LinkedList.printLL(Intersection(LinkedList.createList(new Object[] {LinkedList.printLL(Intersection(LinkedList.createList(new Object[] {
        
    }
    public static Node EvenTofront (Node head){

    ...
    public static Node EvenPartsReversed(Node head){
        ...
        while(N.next != null){
            ...
            if(((int)N.next.elem)%2 == 0){
                ...
                while (((int) trav.elem)%2 == 0) {System.out.println("f"+trav.elem);
                 ...
                 while (s.next.elem != null ) {
                     s=s.next;
                 }s.next = trav; LinkedList.printLL(save); LinkedList.printLL(evens);LinkedList.printLL(trav); System.out.println((int)null%2);
            }

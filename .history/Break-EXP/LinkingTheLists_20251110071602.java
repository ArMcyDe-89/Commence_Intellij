public class LinkingTheLists {
    ...
    public static boolean checkPalindrome(Node head) {
        ...
        while (reach<((count/2)+1)) {System.out.println("M1 - "+M.elem);
            M =M.next;System.out.println("M2 - "+M.elem); reach++;
        }System.out.println("reach "+ reach);
        while (M!=null) {System.out.println("M1 - "+M.elem);
            if((int)M.elem == (int)N.elem){
                M = M.next; continue;
            } return false;
        }return true;

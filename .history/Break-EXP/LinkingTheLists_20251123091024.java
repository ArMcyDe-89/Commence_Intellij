public class LinkingTheLists {
    ...
    public static Node reverseClip(Node HJ, int start,int end) {
        ...
        while (N.next!=null) {
            if (count == end ) {
                save2 = N.next; N.next = null;N=HJ; break;
            }
            N=N.next; count++;
        }LinkedList.printLL(HJ); coun
        // while (N.next!=null) {
        //     if(count == start-1){save1 = N.next; N.next = null;N=HJ;break;}
        //     N=N.next; count++;
        // }
        // save1 = InPlaceReverseList(save1); LinkedList.printLL(save1);
        // while (N.next!=null) {
        //     N=N.next;
        // }N.next =save1;
        // while (N.next!=null) {

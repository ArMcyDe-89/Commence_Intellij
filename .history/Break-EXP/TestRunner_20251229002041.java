...
public class TestRunner {
    public static void main(String[] args) {
        ...
        // tree1.inOrder(tree1); System.out.println(); BSTPrinter.printNode(tree1);// Expected: 20 30 40 50 60 70 80

        // System.out.println("\n--- Test 1: Delete Leaf Node (20) ---");
        // tree1 = BSTNode.deleteWithPred(tree1,20);
        // System.out.print("Result: ");
        // tree1.inOrder(tree1); System.out.println();BSTPrinter.printNode(tree1); // Expected: 30 40 50 60 70 80

        // System.out.println("\n--- Test 2: Delete Node with One Child ---");
        // // Let's create a one-child scenario by adding 90 to 80
        // tree1.insert(tree1,90); System.out.println();BSTPrinter.printNode(tree1);
        // // Now 80 has a right child (90) but no left child.
        // System.out.println("Inserted 90. Now deleting 80 (Node with 1 child)...");
        // tree1 = BSTNode.deleteWithPred(tree1,80);
        // System.out.print("Result: ");
        // tree1.inOrder(tree1); System.out.println();BSTPrinter.printNode(tree1); // Expected: 30 40 50 60 70 90
        ...
        // tree1 = BSTNode.deleteWithPred(tree1,50);
        // System.out.print("Result: ");
        // tree1.inOrder(tree1); System.out.println();BSTPrinter.printNode(tree1);// Expected: 30 40 60 70 90

        BSTNode root = null;

        System.out.println("1. Creating a Skewed Tree (10 -> 20 -> ... -> 70)");
        // Inserting sorted data creates a degenerate tree (like a linked list)
        int[] data = {10, 20, 30, 40, 50, 60, 70};
        for (int val : data) {
            root = BSTNode.insertSkewed(root, val);
        }

        System.out.print("   Current PreOrder (Root first): ");
        BSTNode.printPreOrder(root); BSTPrinter.printNode(root); System.out.println();
        System.out.println("\n   Current Root: " + root.elem);
        System.out.println("   Current Height: " + BSTNode.getHeight(root));
        // Expected: Height 7 (Very bad!)

        System.out.println("\n2. Calling balanceBST()...");
        root = BSTNode.balanceBST(root);

        System.out.println("\n3. Verifying New Tree");
        System.out.print("   New PreOrder: ");
        BSTNode.printPreOrder(root); System.out.println();BSTPrinter.printNode(root);
        System.out.println("\n   New Root: " + root.elem);
        System.out.println("   New Height: " + BSTNode.getHeight(root));

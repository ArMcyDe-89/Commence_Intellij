public class LinkingTheLists {
    ...
    public static void main(String[] args) {
        ...
        Node N = head; while(i<10){N.next = new Node(++i); N = N.next; E.next = new Node((int)(E.elem)+i); E =E.next;} E =eye;
        N = head;
    ...
    public static Node Intersection(Node head, Node eye) {
        ...
        while (N.next!=null && E.next != null){
            if(N.elem == E.elem){inter.elem = N.elem;inter.next = new Node(null); inter = inter.next;LinkedList.printLL(inter);} N = N.next; E= E.next;           
        }
        return inter;        
    }

        ...
        while(N.next != null){
            ...
            if(((int)N.next.elem)%2 == 0 && N.next){
                ...
                while (((int) trav.elem)%2 == 0 && trav != null) {System.out.println("f"+trav.elem);
                    ...
                    trav = trav.next; System.out.println("L"+trav.elem); LinkedList.printLL(evens);
                }save.next = evens; Node s = evens; 
                 while (s.next.elem != null ) {
                     s=s.next;
                 }s.next = trav; LinkedList.printLL(save); LinkedList.printLL(evens);LinkedList.printLL(trav); 
            }
            N = trav;LinkedList.printLL(trav); N =N.next;
        }

...
public class LibrarySystem {
    ...
    public static void returnBook(Book b){
        Returns.enqueue(b);
        pw.println(b.Title + " has been returned.");
        pw.flush();
    }
    ...
    public static void processReturns(){
        ...
        while(!Returns.isEmpty()){
            Book returned  = Returns.dequeue();
            addBook(returned);
        }

        pw.println("All returns has been processed.");
    ...
    public static void lookUp(Member m){  // I do not know what else this function is supposed to do.
    ...
    public static void addBook(Book b){
        if(BookShelf.book == null){ BookShelf.book  = b; b.setAvailable(b.getAvailable()+1); return;}
        BookNode bn = new BookNode(b);
        BookNode nb = BookShelf;

public class Spring25 {
    ...
    static String find_minimum(Edge [] graph){
        ...
        Integer min = Integer.MAX_VALUE, i =-1;
        for(int i=0;i<list.length;i++){if(min<list[i]){min=list[i],i;}}
        return ""+min;
    }
    ...
    public static void main(String[] args) {
        ...
        String resultCity = find_minimum(graph);
        
        System.out.println("City with least incoming traffic: " + resultCity);
        
        // Verification based on Explanation:
        // Incoming for 1: 20 (from 0) + 25 (from 2) + 40 (from 3) = 85.
        // Incoming for others will be higher.
        // Expected Output: 1
        
        if (resultCity.equals("1")) {
            System.out.println("Status: CORRECT");
        } else {
            System.out.println("Status: WRONG");
        }

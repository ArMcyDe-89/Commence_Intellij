...
public class lab9_task1 {
    ...
    public static void laughTale(Integer[] warLords, Edge[] adjL, int sSt, int sP, int lSt, int lP){
        ...
        while(lP>0 && LS<10){
            if(lP>(warLords[LS]+adjL[LS].weight)){ lP-= (warLords[LS]+adjL[LS].weight);LS= adjL[LS].toV;}
        }
        ...
        if(SS == 10){System.out.println("Shanks Wins");return;} System.out.println("Luffy Wins");return

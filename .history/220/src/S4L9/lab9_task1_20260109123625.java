...
public class lab9_task1 {
    ...
    public static void laughTale(Integer[] warLords, Edge[] adjL, int sSt, int sP, int lSt, int lP){
        ...
        while(sP>0 && SS<10){
            if(sP>(warLords[SS]+adjL[SS].weight)){ sP-= (warLords[SS]+adjL[SS].weight);SS= adjL[SS].toV;}
        }
        while(lP> lP>(warLords[LS]+adjL[LS].weight) && LS<10){
            if(){ lP-= (warLords[LS]+adjL[LS].weight);LS= adjL[LS].toV;}

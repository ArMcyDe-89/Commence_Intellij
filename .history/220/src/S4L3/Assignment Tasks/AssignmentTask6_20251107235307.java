public class AssignmentTask6 {
    ...
    public static void pairJoin(DNode dh1, DNode dh2) {
        ...
        while (M != null){
            DNode X = N.next.next; N = N.next;System.out.println(N.elem +" "+ X.elem +" "+M.elem); 
            N.next = M; M.prev = N; M = M.next;
            N = N.next; 
            N.next = X; if(X == null){ N.next = dh1; dh1.prev = N; break;}
            X.prev = N; System.out.println(N.elem +" "+ X.elem +" "+M.elem); LinkedListHelpers.printDummyHeadedDoublyCircularLL(dh1);
        } 

public class AssignmentTask6 {
    ...
    public static void pairJoin(DNode dh1, DNode dh2) {
        ...
        while (M != null){
            DNode X = N.next.next; N = N.next;
            N.next = M; M.prev = N.next; M = M.next;LinkedListHelpers.printDummyHeadedSinglyCircularLL(N,truew);
            N = N.next; N.next = X; X.prev = N;
        } N =N.next; N.next = dh1; dh1.prev = N;
        // TO DO
    }

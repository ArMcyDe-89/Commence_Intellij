public class AssignmentTask6 {
    ...
    public static void pairJoin(DNode dh1, DNode dh2) {
        ...
        while (M != null){
            DNode X = N.next.next; N = N.next;System.out.println(N.elem +" "+ X.elem ); if(X == null){ N.next = dh1; dh1.prev = N; break;}
            N.next = M; M.prev = N.next; M = M.next;
            N = N.next; 
            N.next = X; 
            X.prev = N; LinkedListHelpers.printDummyHeadedDoublyCircularLL(dh1);
        } 

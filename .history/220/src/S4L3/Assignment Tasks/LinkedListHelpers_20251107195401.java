...
public class LinkedListHelpers {
    ...
    // Simple singly-linked node used by the helper methods
    static class Node {
        Object elem;
        Node next;
        Node(Object elem) { this.elem = elem; this.next = null; }
    }

    // Simple doubly-linked node used by the helper methods
    static class DNode {
        Object elem;
        DNode prev;
        DNode next;
        DNode(Object elem) { this.elem = elem; this.prev = null; this.next = null; }
    }
}

public class AssignmentTask6 {
    ...
    public static void pairJoin(DNode dh1, DNode dh2) {
        ...
        while (M!=dh2){ System.out.println(N.elem);
            DNode X = N.next.next; 
            N.next.next= M; M.prev = N.next;
            N.next.next.next = X;System.out.println(N.next.elem);
            N.next.next.next.prev = N.next.next;System.out.println(N.next.elem);
            N = N.next.next;M = M.next; 
        }
        // TO DO
    }

...
public class StackAndQueueAssgnTaskTester {
    ...
    public static void evalMathExpression(String expression) {
        ...
        for(int i = 0; i<expression.length();i++){
            ...
            else if(!((int)expression.charAt(i)>=48 && (int)expression.charAt(i)<=57)&& expression.charAt(i)!='(' && expression.charAt(i)!= ')'  && expression.charAt(i)!= '{'  && expression.charAt(i)!= '}'  && expression.charAt(i)!= ')'){

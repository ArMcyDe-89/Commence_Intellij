...
public class HashTable {
    ...
    public void insert(String key, Integer value){
        ...
        if (this.ht[index] == null) {
            ...
            FruitNode A = new FruitNode(null,null);A.next=this.ht[index]; FruitNode N =A;
            while(N.next!=null){
            ...
            // }
            while (N.next!=null) {
                if((Integer)N.next.fruit[1]<value){
                    FruitNode M = new FruitNode(key, value); M.next = N.next; N.next = M;System.out.println(N.fruit[0]); return;
                }N=N.next;
            }if(N.next==null){FruitNode M = new FruitNode(key, value); M.next = N.next; N.next = M;}
            if (N.next!=null && (int)N.fruit[1]<(int)N.next.fruit[1]) {
                FruitNode M = N; N =N.next; M.next = N.next; N.next = M; this.ht[index]=N;
            }
        }

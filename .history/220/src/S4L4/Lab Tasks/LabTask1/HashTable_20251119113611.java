...
public class HashTable {
    ...
    public void insert(String key, Integer value){
        ...
        if (this.ht[index] == null) {
            ...
            while(N.next!=null){
                if(value>max){
                    FruitNode first = new FruitNode(key, value); first.next = this.ht[index]; this.ht[index] = first; return;
                }
                else if(N.next!=null && (int)N.next.fruit[1]<value){
                    FruitNode en = N.next; N.next = new FruitNode(key, value); N=N.next; N.next = en; re
                }
            }

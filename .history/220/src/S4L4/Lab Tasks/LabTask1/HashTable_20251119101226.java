    ...
    public void insert(String key, Integer value){
        ...
        if (this.ht[index] == null) {
            ...
            while(N.next!=null){
                ...
                N=N.next;
            }FruitNode m = new FruitNode(key, value); m.next = N.next;N.next = m; N = this.ht[index];
            while(N.next!=null){
                if (N.next.next!=null && (Integer)N.next.fruit[1]<(Integer)N.next.next.fruit[1]) {
                    FruitNode M =N.next; N.next= N.next.next; M.next = N.next.next; N.next.next = M; N = this.ht[index];
                }
                FruitNode M = N.next;
                while (M.next!=null) {
                    if((int)N.fruit[1]<(int)M.fruit[1]){
                        FruitNode K = M.next; M.next =
                    }M=M.next;
                }
                N=N.next;
            }N = this.ht[index];
            if ((int)N.fruit[1]<(int)N.next.fruit[1]) {
                FruitNode M = N; N =N.next; M.next = N.next; N.next = M; this.ht[index]=N;
            }
        }
        // TO DO
    }

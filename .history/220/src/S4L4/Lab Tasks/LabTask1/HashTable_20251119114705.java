...
public class HashTable {
    ...
    public void insert(String key, Integer value){
        ...
        if (this.ht[index] == null) {
            ...
            int max = (int)this.ht[index].fruit[1];
            while(N.next!=null){
                if(value>max){
                    FruitNode first = new FruitNode(key, value); first.next = this.ht[index]; this.ht[index] = first; max = value;
                }
                else if(N.next!=null && (int)N.next.fruit[1]<value){
                    FruitNode en = N.next; N.next = new FruitNode(key, value); N=N.next; N.next = en;
                }
                N=N.next;
            }N = this.ht[index];
            while(N.next !=null){
                ...
                while (M.next.next!=null) {
                    if (((String)N.fruit[0]).equals((String)M.next.fruit[0])) {
                        M.next=M.next.next;
                    }M=M.next;
                }N=N.n
            }

...
class CallQueue {
    ...
    public void enqueueCall(int customerId, boolean isVip) {
        if(isVip){vipQueue.enqueue(customerId);
            System.out.printf("Customer %d added to VIP queue.",vipQueue.peek());
            return;
        }
        regularQueue.enqueue(customerId);
        System.out.printf("Customer %d added to Regular queue.",regularQueue.peek());
        return;
        // To Do
    }
    ...
    public void displayQueue() {
        ...
        while (!regularQueue.isEmpty()) {
            System.out.print(regularQueue.dequeue()+"->");
        }System.out.println("NULL");
        // To Do
    }

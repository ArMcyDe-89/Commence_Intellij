...
public class Task3 {
    ...
    public static void task3A(Node head) {
        Node N = head;
        while (N!=null) {
            System.out.println(N.elem); N = N.next;
    ...
    public static int task3C(Node head) {
        int sum = 0; Node N = head;
        while (N!=null) {
            sum+=(int)N.elem; N =N.next;
        }
        // TODO: Implement this using a loop
        return sum;
    }
    ...
    public static int task3D_recursive(Node head) {
        Node N = head; int sum = 0;
        if (N == null) {
            return 0;
        }
        else{
            return sum+=(int)N.elem+(int)task3D_recursive(N.next);
        }
        // TODO: Implement this recursively
    }
    ...
    public static int task3E(Node head) {
        if (head == null) {
            ...
            int sum=0, multi=1; Node N= head;
            while (N!=null) {
                if((int)N.elem%2==0){multi*=(int)N.elem;}else{sum+=(int)N.elem;} N=N.next;
            }return sum-multi;
        }
        // TODO: Implement this using a loop
        //return 0;
    ...
    public static int task3F_recursive(Node head) {
        int sum =add(head), multi = multi(head);
    ...
    public static int add(Node head) {
        if (head == null) {
            ...
            if ((int)N.elem %2 != 0) {
                return (int)N.elem + add(N.next);
            }else{return add(N.next);}
        }
    }
    public static int multi(Node head) {
        if (head == null) {
            return 1;
        }
        else{ Node N = head;
            if ((int)N.elem %2 == 0) {
                return (int)N.elem * multi(N.next);
            }else{return multi(N.next);}
        }
    }

...
public class Task2 {
    ...
    public static int task2F_recursive(int[] arr) {
        int sum = 0, multi =0, i=0;
        if(arr[i]%2==0){sum=sum(arr, i);}else{multi = }
    ...
    public static int sum(int [] arr, int  i) {
        if (i<arr.length) {
            ...
            else{return sum(arr, ++i);}
        }
        else{
            return 0;
        }
    }
    public static int multi(int [] arr, int i) {
        if (i<arr.length) {
            if (arr[i]%2 != 0) {
                return arr[i]*multi(arr, ++i);
            }
            else{return multi(arr, ++i);}
        }
        else{
            return 1;
        }

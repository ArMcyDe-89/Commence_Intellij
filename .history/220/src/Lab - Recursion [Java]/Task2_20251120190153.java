...
public class Task2 {
    ...
    public static void task2A(int[] arr) {
        int i =0;
        while(i<arr.length){System.out.println(arri++);}
    ...
    public static void task2B_recursive(int[] arr, int i) {
        if(i == arr.length-1){System.out.println(arr[i]);return;}
        task2B_recursive(arr, ++i); System.out.println(arr[i]);
    ...
    public static int task2D_recursive(int[] arr, int i) {
        int sum = 0;
        if(i == arr.length-1){sum+=arr[i];return sum;}
        // TODO: Implement this recursively
        return sum+=task2D_recursive(arr, ++i);
    }

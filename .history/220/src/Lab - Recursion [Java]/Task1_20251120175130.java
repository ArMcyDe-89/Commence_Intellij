...
public class Task1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("printing 1A"); task1A();
        System.out.println("printing 1B"); task1B_recursive(10);
        System.out.println("printing to 'n' in 1C. Please enter n:"); task1C(sc.nextInt());
        System.out.println("Printing recursively to n. Please enter n:"); task1D_recursive(1, sc.nextInt());

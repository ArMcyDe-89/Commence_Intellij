...
public class LabTask2 {
    ...
    public static void main(String[] args){
        ...
        Node head = LinkedList.createList(new Character[]{
            new Character('B'), new Character('M'), new Character('D'),
            new Character('T'), new Character('N'), new Character('O'),
            new Character('A'), new Character('P'), new Character('S'),
            new Character('C')
        });
        ...
        Node head = LinkedList.createList(new Character[]{
            Character.valueOf('B'), Character.valueOf('M'), Character.valueOf('D'), 
            Character.valueOf('T'), Character.valueOf('N'), Character.valueOf('O'),
            Character.valueOf('A'), Character.valueOf('P'), Character.valueOf('S'), 
            Character.valueOf('C')
        });
        System.out.print("Encoded Word: ");
        LinkedList.printLL(head);

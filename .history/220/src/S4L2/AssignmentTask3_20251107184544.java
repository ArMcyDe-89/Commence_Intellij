...
public class AssignmentTask3 {
    ...
    public static Node alternateMerge( Node head1, Node head2 ){
        ...
        // while(true){
        //     Node M =N1.next;
        //     N1.next =N2; N1.next =M;
        // }
        Node N = head1, M = head2; int i =0;
        while (N!=null) {
            Node X = N.next; N.next = M; System.out.print("---1---     "); LinkedList.printLL(N);
            M = M.next; System.out.print("---2---    "); LinkedList.printLL(M);
            N = N.next; N.next = X; X=N;N = head1; System.out.print("---3---     "); LinkedList.printLL(N);
        }

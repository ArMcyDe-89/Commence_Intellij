...
public class LabTask2 {
    ...
    public static void main(String[] args){
        ...
        Node head = LinkedList.createList(new Character[]{new Character('B'), new Character('M'), new Character('D'), new Character('T'), new Character('N'), new Character('O'), new Character('A'), new Character('P'), new Character('S'), new Character('C')});
        ...
        head = LinkedList.createList(new Character[]{new Character('Z'), new Character('O'), new Character('T'), new Character('N'), new Character('X')});
        System.out.print("Encoded Word: ");
        LinkedList.printLL(head);

...
public class Task6 {
    ...
    public static Integer levelSum( BTNode root ){
        ...
        // return sum;
        if (getDepth(root)%2 == 0) {
            return  -(int)root.elem+levelSum(root.left)+levelSum(root.right); return sum;
        } sum = (int)root.elem-levelSum(root.right)-levelSum(root.left); return sum;
    }
    ...
    //Credits for the following functions go to AIB sir

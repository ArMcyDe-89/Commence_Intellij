...
public class Runner {
    public static void main(String[] args) {
        ...
        for(int i = 1; i<sortedResult.length/2;i++){int swap = sortedResult[i]; sortedResult[i]=sortedResult[sortedResult.length-1-i];sortedResult[sortedResult.length-1-i]}

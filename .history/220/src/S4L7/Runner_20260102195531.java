...
public class Runner {
    public static void main(String[] args) {
        ...
        Integer [] tasks = new Integer[sc.nextInt()];
        ...
        taskPrint("\n====================== TASK#4 =====================");
        System.out.println("How many numbers will there be? "); int num = sc.nextInt();
        Integer [] nums = new Integer[num];
        for(int i =0; i<num;i++){System.out.print("Please enter a number for index "+i+": "); nums[i]=sc.nextInt();System.out.println();}
        ...
        System.out.println("The biggest elements are:"); printArray(biggest);
        ...
        for(int i = 0; i<priorities.length;i++){Scheduler.insert(task_names[i],priorities[i]);}
        String [] sorted = new String[priorities.length];
        for(int i = 0; i<sorted.length;i++){
            sorted[i] = Scheduler.extractMaxS();
        }
...
System.out.println("Time (ms): " + (end - start) / 1_000_000.0);
    ...
    // The following lines of code were provided by AIB sir

public class QuizThreeD {
    ...
    static Integer maxOccupiedRoom(int n, int[][] meetings, MaxHeap heap) {
        ...
        return max.extractMaxNode().room;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Test Case 1: " + findMaxOccupiedRoom(n1, meetings1.max1)); 
        // Expected: 0 (Room 0: 20, Room 1: 15, Room 2: 0)

        // Test Case 2
        int n2 = 2;
        int[][] meetings2 = {{1,4,0}, {5,8,1}, {2,6,0}};
                MaxHeap max = new MaxHeap(meetings2.length);
        System.out.println("Test Case 2: " + findMaxOccupiedRoom(n2, meetings2)); 
        // Expected: 0 (Room 0: 7, Room 1: 3)

        // Test Case 3
        int n3 = 3;
        int[][] meetings3 = {{0,5,1}, {5,10,2}, {10,15,1}};
        System.out.println("Test Case 3: " + findMaxOccupiedRoom(n3, meetings3)); 

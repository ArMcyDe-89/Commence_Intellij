...
public class QuizTwoA {
    public Integer maxTreasurePath(BTNode root){
        ...
        String s="",d="";
        Integer L = maxTreasurePath(root.left);if(L != null){s=""+L;}
        Integer R = maxTreasurePath(root.right);if(L != null){s=""+R;}
        String maxL = ""+root.elem+s;
        String maxR = ""+root.elem+d;
    ...
    public void main(String[] args) {
        ...
        System.out.println("MAx val: "+ maxTreasurePath(root));

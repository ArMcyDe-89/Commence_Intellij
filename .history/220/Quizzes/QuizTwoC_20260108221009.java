...
public class QuizTwoC {
    ...
    public Integer findMax(BTNode root){
        if(root == null){ return 0;} if(root.left == null &&  root.right!= null){return (int)root.right.elem;}
        if(root.left == null &&  root.right!= null){return (int)root.right.elem;}
        if(root.left != null &&  root.right== null){return (int)root.left.elem;}
        return 
    }
}

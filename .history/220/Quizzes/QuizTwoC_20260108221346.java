...
public class QuizTwoC {
    ...
    public Integer findMax(BTNode root, int min){
        if(root == null){ return 0;} if(root.left == null &&  root.right == null){return (int)root.elem;}
        if(root.right!= null){return (int)root.right.elem;}
        if(root.left != null ){return (int)root.left.elem;}
        return (int)root.right.elem>(int)root.left.elem? 
    }
}

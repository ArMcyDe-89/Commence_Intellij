public class QuizThreeD {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Expected: 0 (Room 0: 20, Room 1: 15, Room 2: 0)");
        ...
        System.out.println("Expected: 0 (Room 0: 7, Room 1: 3)");

        // Test Case 3
        int n3 = 3;
        int[][] meetings3 = {{0,5,1}, {5,10,2}, {10,15,1}};
        MaxHeap max3 = new MaxHeap(meetings3.length);
        System.out.println("Test Case 3: " + maxOccupiedRoom(n3, meetings3,max3)); 
        System.out.println("Expected: 1 (Room 1: 10, Room 2: 5, Room 0: 0)");
    }

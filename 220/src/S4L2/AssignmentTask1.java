...
public class AssignmentTask1 {
    ...
    public static String checkSimilar( Node building1, Node building2 ){
        ...
        int b1=0,b2=0; Node N1 = building1; Node N2 = building2;
        while(N1!=null){
            N1=N1.next; b1++;
        }N1 = building1;
        ...
        if(b1!=b2){return "Not Similar";}

        int c=0;
        while (true) {
            if(!(((String)(N1.elem)).equals((String)N2.elem))){
                return "Not Similar";
            } N1=N1.next; N2 = N2.next; c++; if(c==b1){break;}
        } return "Similar";
